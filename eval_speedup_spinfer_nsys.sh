...
# Init_spdp set
S_1_SET=(0.45 0.5 0.55 0.6 0.65 0.7 0.75 0.8)
FORMAT=spinfer
...
for ((i=0; i<${#S_1_SET[@]}; i++)); do
    ...
    # --cuda-event-trace=false for runtime overhead reduction and false dependencies
    nsys profile -f true --cuda-event-trace=false -o $SPDP_HOME/e2ellm_spinfer${S_1} python run_sparse_model.py \
